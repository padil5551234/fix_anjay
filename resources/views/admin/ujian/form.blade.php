        ...
        <form action="" method="post" class="form-horizontal needs-validation" autocomplete="off" novalidate>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row required">
                        <label for="paket_ujian" class="col-sm-3 col-form-label control-label">Paket Ujian</label>
                        <div class="col-sm-9">
                            <select class="form-control select2" name="paket_ujian[]" id="paket_ujian" multiple="multiple" required style="width: 100%;">
                            </select>
                            <small class="form-text text-muted">Pilih paket ujian yang akan menampilkan ujian ini. Bisa pilih lebih dari satu.</small>
                            <div class="invalid-feedback">
                                Minimal pilih satu paket ujian.
                            </div>
                        </div>
                    </div>
